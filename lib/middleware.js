        ...
        request(options, function(error, response, body) {
            if (error) {
                ...
                try {
                    ...
                    if (err) {
                        console.error('ERROR in botkit-middleware-bcrm parsing JSON:', err);
                    }
                }

                if (!json) {
                    console.error('ERROR in botkit-middleware-bcrm parsing JSON!');
                } else {
                    if (!json.success) {
                        console.error('WARNING: Botkit-middleware-bcrm received non-success response!', json);
                    } else {
                        // This was a successful API call as far as we know.
                    }
                }
            }
        });
